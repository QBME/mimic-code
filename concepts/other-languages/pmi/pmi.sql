...
DROP TABLE IF EXISTS TMP_COOCCUR;

SET SESSION tmp_table_size = 1024 * 1024 * 1024 * 8;
SET SESSION max_heap_table_size = 1024 * 1024 * 1024 * 8;
...
CREATE TABLE TMP_COOCCUR (
	SUBJECT_ID mediumint(8) unsigned,
    ITEMID smallint(5) unsigned,
	INDICATOR char,
    DRUG varchar(255),
    INDEX (SUBJECT_ID,ITEMID,INDICATOR,DRUG)
) ENGINE MEMORY;

INSERT IGNORE INTO TMP_COOCCUR
SELECT
p.SUBJECT_ID,
e.ITEMID,
e.INDICATOR,
p.DRUG
FROM LABEVENTS e, PRESCRIPTIONS p
